			...
			<div class="calc-form" style="background-image:url(<?php echo esc_url( $bg_url ) ?>)">
				<form>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<div class="calc-form-total">
												<span class="calc-form-total-v-container"><span class="calc-form-total-v"><?php echo esc_html( $block['data']['price'] ) ?></span></span> <span>руб./мес.</span></div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="calc-form-submit form-submit">
						<input class="btn-primary btn-wide btn" data-fancybox data-src="#popup-calc" type="button" value="<?php echo esc_attr( __( 'Submit Order', 'resto' ) ) ?>">
					</div>
				</form>
			</div>
